...
public class EnemyPacmanBlue extends JPanel {
    /**
     *
     */
    ...
    public void load() {
        enemyXCoordinate = 600;//
        enemyYCoordinate = 135;//
        movingRight = true;//
        movingLeft = false;//
        moveUp = false;
        moveDown = false;
		...
		for(int i=0;i<=8;i++)
			repeat[i]=false;*/
        enemypacgameZoon = PlayPanel.GAMEZOON.zoon7;//
        random = new Random();
        try {
    ...
    public void changePac() {
        if (moveUp) {
            try {
                enemypacman1 = new ImageIcon(getClass().getResource("/images/Enemy Pac/blueuppac.gif"));
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else if (movingLeft) {
            ...
            try {
                enemypacman1 = new ImageIcon(getClass().getResource("/images/Enemy Pac/bluedownpac.gif"));
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        }
    ...
    public void checkEnemyPacmanZoon() {
        if (EnemyPacmanBlue.enemyYCoordinate >= 522 && EnemyPacmanBlue.enemyYCoordinate <= 530) {
            EnemyPacmanBlue.enemypacgameZoon = PlayPanel.GAMEZOON.zoon1;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanBlue.enemyYCoordinate >= 454 && EnemyPacmanBlue.enemyYCoordinate <= 466) {
            EnemyPacmanBlue.enemypacgameZoon = PlayPanel.GAMEZOON.zoon2;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanBlue.enemyYCoordinate >= 386 && EnemyPacmanBlue.enemyYCoordinate <= 398) {
            EnemyPacmanBlue.enemypacgameZoon = PlayPanel.GAMEZOON.zoon3;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanBlue.enemyYCoordinate >= 322 && EnemyPacmanBlue.enemyYCoordinate <= 330) {
            EnemyPacmanBlue.enemypacgameZoon = PlayPanel.GAMEZOON.zoon4;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanBlue.enemyYCoordinate >= 254 && EnemyPacmanBlue.enemyYCoordinate <= 266) {
            EnemyPacmanBlue.enemypacgameZoon = PlayPanel.GAMEZOON.zoon5;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanBlue.enemyYCoordinate >= 194 && EnemyPacmanBlue.enemyYCoordinate <= 198) {
            EnemyPacmanBlue.enemypacgameZoon = PlayPanel.GAMEZOON.zoon6;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanBlue.enemyYCoordinate >= 130 && EnemyPacmanBlue.enemyYCoordinate <= 138) {
            EnemyPacmanBlue.enemypacgameZoon = PlayPanel.GAMEZOON.zoon7;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanBlue.enemyYCoordinate >= 62 && EnemyPacmanBlue.enemyYCoordinate <= 74) {
            EnemyPacmanBlue.enemypacgameZoon = PlayPanel.GAMEZOON.zoon8;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanBlue.enemyYCoordinate >= 0 && EnemyPacmanBlue.enemyYCoordinate <= 6) {
            EnemyPacmanBlue.enemypacgameZoon = PlayPanel.GAMEZOON.zoon9;
            PlayPanel.stateUndefined = false;
        } else {
            ...
            if (moveDown) {
                EnemyPacmanBlue.enemyYCoordinate++;
                EnemyPacmanBlue.enemyYCoordinate++;
            } else if (moveUp) {
                enemyYCoordinate--;
                enemyYCoordinate--;
