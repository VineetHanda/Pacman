...
public class EnemyPacmanPurple extends JPanel {
    /**
     *
     */
    ...
    public void load() {
        enemyXCoordinate = 500;//
        enemyYCoordinate = 324;//
        movingRight = false;//
        movingLeft = true;//
        moveUp = false;
        moveDown = false;
		...
		for(int i=0;i<=8;i++)
			repeat[i]=false;*/
        enemypacgameZoon = PlayPanel.GAMEZOON.zoon4;//
        random = new Random();
        try {
    ...
    public void changePac() {
        if (moveUp) {
            try {
                enemypacman1 = new ImageIcon(getClass().getResource("/images/Enemy Pac/purpleuppac.gif"));
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else if (movingLeft) {
            ...
            try {
                enemypacman1 = new ImageIcon(getClass().getResource("/images/Enemy Pac/purpledownpac.gif"));
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        }
    ...
    public void checkEnemyPacmanZoon() {
        if (EnemyPacmanPurple.enemyYCoordinate >= 522 && EnemyPacmanPurple.enemyYCoordinate <= 530) {
            EnemyPacmanPurple.enemypacgameZoon = PlayPanel.GAMEZOON.zoon1;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanPurple.enemyYCoordinate >= 454 && EnemyPacmanPurple.enemyYCoordinate <= 466) {
            EnemyPacmanPurple.enemypacgameZoon = PlayPanel.GAMEZOON.zoon2;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanPurple.enemyYCoordinate >= 386 && EnemyPacmanPurple.enemyYCoordinate <= 398) {
            EnemyPacmanPurple.enemypacgameZoon = PlayPanel.GAMEZOON.zoon3;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanPurple.enemyYCoordinate >= 322 && EnemyPacmanPurple.enemyYCoordinate <= 330) {
            EnemyPacmanPurple.enemypacgameZoon = PlayPanel.GAMEZOON.zoon4;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanPurple.enemyYCoordinate >= 254 && EnemyPacmanPurple.enemyYCoordinate <= 266) {
            EnemyPacmanPurple.enemypacgameZoon = PlayPanel.GAMEZOON.zoon5;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanPurple.enemyYCoordinate >= 194 && EnemyPacmanPurple.enemyYCoordinate <= 198) {
            EnemyPacmanPurple.enemypacgameZoon = PlayPanel.GAMEZOON.zoon6;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanPurple.enemyYCoordinate >= 130 && EnemyPacmanPurple.enemyYCoordinate <= 138) {
            EnemyPacmanPurple.enemypacgameZoon = PlayPanel.GAMEZOON.zoon7;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanPurple.enemyYCoordinate >= 62 && EnemyPacmanPurple.enemyYCoordinate <= 74) {
            EnemyPacmanPurple.enemypacgameZoon = PlayPanel.GAMEZOON.zoon8;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanPurple.enemyYCoordinate >= 0 && EnemyPacmanPurple.enemyYCoordinate <= 6) {
            EnemyPacmanPurple.enemypacgameZoon = PlayPanel.GAMEZOON.zoon9;
            PlayPanel.stateUndefined = false;
        } else {
            ...
            if (moveDown) {
                EnemyPacmanPurple.enemyYCoordinate++;
                EnemyPacmanPurple.enemyYCoordinate++;
            } else if (moveUp) {
                enemyYCoordinate--;
                enemyYCoordinate--;
