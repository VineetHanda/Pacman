...
public class EnemyPacmanRed extends JPanel {
    /**
     *
     */
    ...
    public void load() {
		...
		for(int i=0;i<=8;i++)
			repeat[i]=false;*/
        enemypacgameZoon = PlayPanel.GAMEZOON.zoon3;
        random = new Random();
        try {
            enemypacman1 = new ImageIcon(getClass().getResource("/images/Enemy Pac/redrightpac.gif"));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public void updateEnemyPacman() {
		...
		/*if(enemyXCoordinate>650)
		{
			...
			try
		    {
		        enemypacman1=new ImageIcon(getClass().getResource("/images/Enemy Pac/redleftpac.gif"));
		    }
		    catch (Exception ex) {
		      ex.printStackTrace();
		    }
    ...
    public void changePac() {
        if (moveUp) {
            try {
                enemypacman1 = new ImageIcon(getClass().getResource("/images/Enemy Pac/reduppac.gif"));
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else if (movingLeft) {
            ...
            try {
                enemypacman1 = new ImageIcon(getClass().getResource("/images/Enemy Pac/reddownpac.gif"));
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        }
    ...
    public void checkEnemyPacmanZoon() {
        if (EnemyPacmanRed.enemyYCoordinate >= 522 && EnemyPacmanRed.enemyYCoordinate <= 530) {
            EnemyPacmanRed.enemypacgameZoon = PlayPanel.GAMEZOON.zoon1;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanRed.enemyYCoordinate >= 454 && EnemyPacmanRed.enemyYCoordinate <= 466) {
            EnemyPacmanRed.enemypacgameZoon = PlayPanel.GAMEZOON.zoon2;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanRed.enemyYCoordinate >= 386 && EnemyPacmanRed.enemyYCoordinate <= 398) {
            EnemyPacmanRed.enemypacgameZoon = PlayPanel.GAMEZOON.zoon3;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanRed.enemyYCoordinate >= 322 && EnemyPacmanRed.enemyYCoordinate <= 330) {
            EnemyPacmanRed.enemypacgameZoon = PlayPanel.GAMEZOON.zoon4;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanRed.enemyYCoordinate >= 254 && EnemyPacmanRed.enemyYCoordinate <= 266) {
            EnemyPacmanRed.enemypacgameZoon = PlayPanel.GAMEZOON.zoon5;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanRed.enemyYCoordinate >= 194 && EnemyPacmanRed.enemyYCoordinate <= 198) {
            EnemyPacmanRed.enemypacgameZoon = PlayPanel.GAMEZOON.zoon6;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanRed.enemyYCoordinate >= 130 && EnemyPacmanRed.enemyYCoordinate <= 138) {
            EnemyPacmanRed.enemypacgameZoon = PlayPanel.GAMEZOON.zoon7;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanRed.enemyYCoordinate >= 62 && EnemyPacmanRed.enemyYCoordinate <= 74) {
            EnemyPacmanRed.enemypacgameZoon = PlayPanel.GAMEZOON.zoon8;
            PlayPanel.stateUndefined = false;
        } else if (EnemyPacmanRed.enemyYCoordinate >= 0 && EnemyPacmanRed.enemyYCoordinate <= 6) {
            EnemyPacmanRed.enemypacgameZoon = PlayPanel.GAMEZOON.zoon9;
            PlayPanel.stateUndefined = false;
        } else {
            ...
            if (moveDown) {
                EnemyPacmanRed.enemyYCoordinate++;
                EnemyPacmanRed.enemyYCoordinate++;
            } else if (moveUp) {
                enemyYCoordinate--;
                enemyYCoordinate--;
