...
public class Window_Register implements KeyListener {
    //Instance varibales
    JFrame windowFrame;
    JLabel blackback;
    Fade fade;
    ...
    public void showWindowRegister() {
        ...
        try {
            blackback = new JLabel(new ImageIcon(ImageIO.read(getClass().getResourceAsStream("/images/menu images/blackback_register.png"))));
        } catch (Exception e) {
            e.printStackTrace();
        }
